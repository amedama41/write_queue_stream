...
namespace detail {
  ...
  namespace bind_handler_detail {
    ...
    auto asio_handler_allocate(
        std::size_t const size, binder1<Handler, Arg1>* const this_handler)
      -> void*
    {
    ...
    void asio_handler_deallocate(
        ...
        , binder1<Handler, Arg1>* const this_handler)
    {
    ...
    void asio_handler_invoke(
        Function&& function, binder1<Handler, Arg1>* const this_handler)
    {
    ...
    public:
      ...
      {
        handler_(
            static_cast<Arg1 const&>(arg1_), static_cast<Arg2 const&>(arg2_));
      }
    ...
    auto asio_handler_allocate(
        ...
        , binder2<Handler, Arg1, Arg2>* const this_handler)
      -> void*
    {
      using boost::asio::asio_handler_allocate;
      return asio_handler_allocate(
    ...
    void asio_handler_invoke(
        Function&& function, binder2<Handler, Arg1, Arg2>* const this_handler)
    {
      using boost::asio::asio_handler_invoke;
      asio_handler_invoke(
            std::forward<Function>(function)
